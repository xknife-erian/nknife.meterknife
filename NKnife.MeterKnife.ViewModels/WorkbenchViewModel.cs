...
namespace NKnife.MeterKnife.ViewModels
{
    public class WorkbenchViewModel : ViewModelBase, IWorkbenchViewModel
    {
        ...
        public WorkbenchViewModel(IStoragePlatform<Engineering> engineeringStoragePlatform, IStoragePlatform<Slot> slotStoragePlatform)
        {
        ...
        public async Task<bool> CreatMeterCareSlot(short port)
        {
            var slot = new Slot();
