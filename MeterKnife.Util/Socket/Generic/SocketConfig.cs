...
namespace MeterKnife.Util.Socket.Generic
{
    public abstract class SocketConfig : ITunnelConfig
    {
        ...
        {
            get => int.Parse(_Map["ReceiveBufferSize"].ToString());
            set => _Map["ReceiveBufferSize"] = value;
        }

        public int SendBufferSize
        {
            get => int.Parse(_Map["SendBufferSize"].ToString());
            set => _Map["SendBufferSize"] = value;
        }

        public virtual int MaxBufferSize
        {
            get => int.Parse(_Map["MaxBufferSize"].ToString());
            set => _Map["MaxBufferSize"] = value;
        }

        public virtual int MaxConnectCount
        {
            get => int.Parse(_Map["MaxConnectCount"].ToString());
            set => _Map["MaxConnectCount"] = value;
        }

        public virtual int ReceiveTimeout
        {
            get => int.Parse(_Map["ReceiveTimeout"].ToString());
            set => _Map["ReceiveTimeout"] = value;
        }

        public virtual int SendTimeout
        {
            get => int.Parse(_Map["SendTimeout"].ToString());
            set => _Map["SendTimeout"] = value;
        }
