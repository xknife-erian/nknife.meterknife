...
namespace NKnife.MeterKnife.Base
{
    ...
    public interface IStorageDUTWrite<in T>
    {
        ...
        Task<bool> InsertAsync(Project project);
        ...
        Task<bool> InsertAsync((Project, DUT) dut, T domain);
        ...
        Task<bool> InsertManyAsync((Project, DUT) dut, IEnumerable<T> domains);
        ...
        /// <param name="dut">指定的被测试物</param>
        /// <param name="domain">指定的对象</param>
        Task<bool> UpdateAsync((Project, DUT) dut, T domain);
        ...
        Task<bool> RemoveAsync((Project, DUT) dut, DateTime id);
    }
}