...
namespace MeterKnife.Views.InstrumentsDiscovery.Controls.Instruments
{
    public sealed partial class InstrumentCell : UserControl
    {
        ...
        private void DrawImage(Graphics g)
        {
            ...
            var actualRect = AdjustSize(_ImgRectangle, Instrument.Image.Width, Instrument.Image.Height);
        ...
        /// 保持比例图像缩放简易算法
        /// </summary>
        private static Rectangle AdjustSize(Rectangle boxRectangle, int imageWidth, int imageHeight)
        {
