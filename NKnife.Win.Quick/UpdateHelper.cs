...
namespace NKnife.Win.Quick
{
    class UpdateHelper
    {
        ...
        {
            var adminTip = "更新程序在更新过程中因为要覆盖原有文件，所以需要管理员权限才能更新。";
            var ds = MessageBox.Show($"即将更新。准备关闭应用程序进行更新。\r\n{adminTip}", "准备更新", MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
