...
namespace MeterKnife.Electronics.Collections
{
    /// <summary>电阻对象的集合。
    ...
    public class Resistances : IList<NKnife.Electronics.Resistance>
    {
        ...
        public Resistances()
            : this(4, NKnife.Electronics.CircuitType.Series)
        {
        }

        public Resistances(int capacity, NKnife.Electronics.CircuitType circuitType)
        {
        ...
        /// </summary>
        public NKnife.Electronics.CircuitType CircuitType { get; set; }
        ...
        public double EquivalentValue
        {
            get
            {
                switch (CircuitType)
                {
                    case NKnife.Electronics.CircuitType.Series:
                        return SeriesEquivalentValue();
                    case NKnife.Electronics.CircuitType.Paralleling:
