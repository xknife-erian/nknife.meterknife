...
####2017年5月1日
笔者自从2015年始，在对该领域的零认识的时机启动开发，在0.1-1.0.x的开发阶段，完全处于摸着手头过河的阶段。在那个阶段，从技术路线的选择，核心技术点的解决方案等都没有经验。当1.0.x发布以后，有近百名使用者在近一年的使用过程中提出了近百条应用经验与建议。2017年5月1日，本软件进入到第二轮正式开发阶段，对过去的开发成果将全部推翻与重构。原开发成果置入分支1.0-lite，以便维护。Master将进入2.0开发的主线。此轮开发，将会带来：
