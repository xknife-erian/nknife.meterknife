...
namespace NKnife.MeterKnife.Plots.Util
{
    /// <summary>
    ...
    public class PlotSeriesStyleSolution
    {
        ...
        public int IndexOf(string exhibit)
        {
        ...
        //     for (int i = 0; i < Styles.Count; i++)
        //     {
        //         if (Styles[i].Exhibit.Equals(exhibitId))
        //             return i;
        //     }
        //     return -1;
        // }
        ...
        {
            public ExhibitSeriesStyle(string exhibit, PlotSeriesStyle seriesStyle)
            {
                Id = Guid.NewGuid();
                Exhibit = exhibit;
